...
class TradingContext:
    ...
    def add_data_columns(self):
        ...
        self.dataloader.df_new_column(COLUMN_PROFIT_MAX, 0.0,float)
        self.dataloader.df_new_column(COLUMN_PROFIT_MIN, 0.0,float)
        self.dataloader.df_new_column(COLUMN_PROFIT_MEAN, 0.0,float)
    ...
    def get_entry_price(self) -> float:
        ...
        Returns:
            float: エントリー価格。
        """
        return self.dataloader.get_df(self.entry_index, COLUMN_ENTRY_PRICE)
    ...
    def get_exit_price(self) -> float:
        ...
        Returns:
            float: エグジット価格。
        """
        return self.dataloader.get_df(self.exit_index, COLUMN_EXIT_PRICE)
