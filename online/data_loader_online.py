...
class DataLoaderOnline(DataLoaderDB):
    ...
    def fetch_historical_data_all(self, start_date, end_date):
        """
        指定された期間の全てのデータを取得する。
        """
        dfres = self.bybit_online_api.fetch_historical_data_all(start_date, end_date)
        self.import_to_db(dataframe=dfres)
        return dfres
    ...
    def update_historical_data_to_now(self):
        """
        指定された期間のデータを更新する。
        """
