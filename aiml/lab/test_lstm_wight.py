...
feature_columns = ['close','rsi_sell','rsi_buy','dmi_diff','macd_diff']
#feature_columns = ['close','sma','volume']
...
x_train, x_test, y_train, y_test = train_test_split(scaled_sequences, targets, test_size=0.2, random_state=12)
...
# モデルのトレーニング
lstm_model.fit(x_train, y_train, epochs=100, batch_size=32,class_weight=class_weights_dict)
